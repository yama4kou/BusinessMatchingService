...
//	}
	...
	@GetMapping("/")
	public String judgeMypage(HttpServletRequest request) {
		System.out.println("こことおってるよ");
		...
		if(roles.contains("ROLE_管理者")) {
			...
			return "redirect:/editorMypage";
		}else if(roles.contains("ROLE_ユーザー")) {
			return "redirect:/createrMypage";
		}
		
		//閲覧ユーザーの時
		return "redirect:/userMypage";// ダッシュボードページへリダイレクト
	}
