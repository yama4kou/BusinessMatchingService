...
public class ProjectSecurityConfig  {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers("/adminDashboard").hasAnyAuthority("ROLE_管理者")
		.requestMatchers("/createrDashboard").hasAnyAuthority("ROLE_ユーザー")
		.requestMatchers("/editorDashboard").hasAnyAuthority("ROLE_承認者")
		.requestMatchers("/userDashboard").hasAnyAuthority("ROLE_閲覧ユーザー")
